...
const SettingsReducer = (state, action) => {
    ...
    switch (action.type) {
        ...
        case 'FETCH_SETTINGS':
            ...
            if( typeof action.payload.fetchedSettings.netlify_deploy_options_fetch_settings_errors !== 'undefined'){
                newState.notice = __('An error occurred.','netlify-deploy');
        ...
        case 'UPDATE_SETTINGS':
            ...
            let canSave = false,
                notice = __('Saved Successfully.','netlify-deploy'),
                hasError = false;
            if( typeof action.payload.fetchedSettings.netlify_deploy_options_update_settings_errors !== 'undefined'){
                canSave = true;
                notice = __('An error occurred.','netlify-deploy');
                hasError = true;
            }
